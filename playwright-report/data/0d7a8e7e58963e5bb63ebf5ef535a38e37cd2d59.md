...
- Name: e2e/recipes.spec.ts >> Recipes >> user can open a single recipe and see its details
- Location: all_tests/e2e/recipes.spec.ts:18:7
...
```ts
  ...
  17 |     this.title = page.getByRole("heading", { name: "Recipes" });
